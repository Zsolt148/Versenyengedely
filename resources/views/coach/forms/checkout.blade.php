        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5 dark:bg-gray-600 mt-10">
                <div class="flex flex-row flex-wrap justify-center my-auto">
                    ...
                    <div class="sm:ml-20">
                        <h1 class="text-2xl">Összesen fizetendő: {{ count($forms) * 1000 }} Ft</h1>
                        <span class="text-gray-600 dark:text-gray-200 text-sm">1000 Ft versenyengedélyenként + egyéb költségek</span><br>
                        <div class="mt-4">
