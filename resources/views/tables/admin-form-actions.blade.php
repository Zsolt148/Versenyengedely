<div class="flex space-x-1 justify-around">
    @php $status = \App\Models\Form::find($id)->status; @endphp
    ...
    <button wire:click="editForm({{$id}})" class="p-1 text-blue-600 dark:text-blue-400 hover:bg-blue-600 hover:text-white rounded disabled:opacity-50" @if($status == "saved" || $status == "expired_sport") disabled @endif>
