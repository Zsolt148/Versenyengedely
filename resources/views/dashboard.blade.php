            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-5 pb-10 sm:px-10 bg-white border-b border-gray-200 dark:bg-gray-600 dark:border-gray-900">
                    ...
                    <div class="flex flex-col space-y-1 my-6">
                        <div class="font-semibold text-blue-600 dark:text-blue-400"><a href="/docs/Versenyengedely_cikk_20210221.pdf" target="_blank" class="ml-1 underline">Általános Tájékozató</a><span class="ml-2 rounded-full bg-gray-300 text-gray-800 px-2 py-1 text-xs font-bold">pdf</span></div>
                        <div class="font-semibold text-blue-600 dark:text-blue-400"><a href="/docs/Versenyengedely_csapatvezetoi_meghatalmazas.docx"class="ml-1 underline">Meghatalmazás csapatvezetőnek</a><span class="ml-2 rounded-full bg-blue-300 text-blue-800 px-2 py-1 text-xs font-bold">docx</span></div>
