    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-center text-gray-500 dark:text-gray-200 uppercase hover:underline">vagy email címmel</a>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600 dark:text-gray-100">{{ __('Emlékezz rám') }}</span>
                </label>
            </div>
